...
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "ADDON_LOADED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_TARGET_CHANGED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_REGEN_ENABLED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_REGEN_DISABLED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "GROUP_ROSTER_UPDATE")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "GROUP_JOINED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "GROUP_LEFT")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "ZONE_CHANGED_NEW_AREA")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_ENTERING_WORLD")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_MOUNT_DISPLAY_CHANGED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_STARTED_MOVING")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_STOPPED_MOVING")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_IMPULSE_APPLIED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UNIT_ENTERED_VEHICLE")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UNIT_EXITED_VEHICLE")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UPDATE_OVERRIDE_ACTIONBAR")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UPDATE_POSSESS_BAR")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UPDATE_VEHICLE_ACTIONBAR")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "UPDATE_SHAPESHIFT_FORM")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_FLAGS_CHANGED")
pcall(visibilityEventFrame.RegisterEvent, visibilityEventFrame, "PLAYER_IS_GLIDING_CHANGED")
pcall(visibilityEventFrame.RegisterUnitEvent, visibilityEventFrame, "UNIT_HEALTH", "player")
pcall(visibilityEventFrame.RegisterUnitEvent, visibilityEventFrame, "UNIT_MAXHEALTH", "player")
