...
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "BAG_UPDATE_COOLDOWN")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "BAG_UPDATE_DELAYED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "ITEM_COUNT_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_EQUIPMENT_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_TARGET_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_FOCUS_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_SOFT_ENEMY_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_SOFT_FRIEND_CHANGED")
pcall(cdEventFrame.RegisterUnitEvent, cdEventFrame, "UNIT_FACTION", "target")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_TOTEM_UPDATE")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_REGEN_DISABLED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "PLAYER_REGEN_ENABLED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "UPDATE_MACROS")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "SPELLS_CHANGED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "UPDATE_SHAPESHIFT_FORM")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "UPDATE_SHAPESHIFT_FORMS")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "SPELL_UPDATE_USABLE")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "SPELL_RANGE_CHECK_UPDATE")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "SPELL_ACTIVATION_OVERLAY_GLOW_SHOW")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "SPELL_ACTIVATION_OVERLAY_GLOW_HIDE")
pcall(cdEventFrame.RegisterUnitEvent, cdEventFrame, "UNIT_SPELLCAST_STOP", "player")
pcall(cdEventFrame.RegisterUnitEvent, cdEventFrame, "UNIT_SPELLCAST_CHANNEL_START", "player")
pcall(cdEventFrame.RegisterUnitEvent, cdEventFrame, "UNIT_SPELLCAST_CHANNEL_STOP", "player")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "COOLDOWN_VIEWER_TABLE_HOTFIXED")
pcall(cdEventFrame.RegisterEvent, cdEventFrame, "COOLDOWN_VIEWER_SPELL_OVERRIDE_UPDATED")
