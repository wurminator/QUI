...
pcall(qolFrame.RegisterEvent, qolFrame, "MERCHANT_SHOW")
pcall(qolFrame.RegisterEvent, qolFrame, "LFG_ROLE_CHECK_SHOW")
pcall(qolFrame.RegisterEvent, qolFrame, "PARTY_INVITE_REQUEST")
pcall(qolFrame.RegisterEvent, qolFrame, "CONFIRM_SUMMON")
pcall(qolFrame.RegisterEvent, qolFrame, "RESURRECT_REQUEST")
pcall(qolFrame.RegisterEvent, qolFrame, "PLAYER_REGEN_ENABLED")
pcall(qolFrame.RegisterEvent, qolFrame, "DUEL_REQUESTED")
pcall(qolFrame.RegisterEvent, qolFrame, "PET_BATTLE_PVP_DUEL_REQUESTED")
pcall(qolFrame.RegisterEvent, qolFrame, "PLAYER_DEAD")
pcall(qolFrame.RegisterEvent, qolFrame, "QUEST_DETAIL")
pcall(qolFrame.RegisterEvent, qolFrame, "QUEST_COMPLETE")
pcall(qolFrame.RegisterEvent, qolFrame, "GOSSIP_SHOW")
pcall(qolFrame.RegisterEvent, qolFrame, "GOSSIP_CLOSED")
pcall(qolFrame.RegisterEvent, qolFrame, "LOOT_READY")
pcall(qolFrame.RegisterEvent, qolFrame, "CHALLENGE_MODE_START")
pcall(qolFrame.RegisterEvent, qolFrame, "CHALLENGE_MODE_COMPLETED")
pcall(qolFrame.RegisterEvent, qolFrame, "CHALLENGE_MODE_RESET")
pcall(qolFrame.RegisterEvent, qolFrame, "PLAYER_ENTERING_WORLD")
pcall(qolFrame.RegisterEvent, qolFrame, "ZONE_CHANGED_NEW_AREA")
pcall(qolFrame.RegisterEvent, qolFrame, "ADDON_LOADED")
pcall(qolFrame.RegisterEvent, qolFrame, "AUCTION_HOUSE_SHOW")
...
do
    ...
    local function RefreshAppearanceChanges()
        ...
        pcall(frame.RegisterUnitEvent, frame, "UNIT_SPELLCAST_CHANNEL_STOP", "player")
