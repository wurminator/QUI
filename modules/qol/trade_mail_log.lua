...
pcall(frame.RegisterEvent, frame, "TRADE_SHOW")
pcall(frame.RegisterEvent, frame, "TRADE_CLOSED")
pcall(frame.RegisterEvent, frame, "TRADE_ACCEPT_UPDATE")
pcall(frame.RegisterEvent, frame, "TRADE_UPDATE")
pcall(frame.RegisterEvent, frame, "TRADE_PLAYER_ITEM_CHANGED")
pcall(frame.RegisterEvent, frame, "TRADE_TARGET_ITEM_CHANGED")
pcall(frame.RegisterEvent, frame, "TRADE_MONEY_CHANGED")
pcall(frame.RegisterEvent, frame, "PLAYER_TRADE_MONEY")
pcall(frame.RegisterEvent, frame, "MAIL_SHOW")
pcall(frame.RegisterEvent, frame, "MAIL_SEND_SUCCESS")
pcall(frame.RegisterEvent, frame, "MAIL_FAILED")
