...
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_START", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_STOP", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_DELAYED", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_CHANNEL_START", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_CHANNEL_UPDATE", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_CHANNEL_STOP", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_INTERRUPTIBLE", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_NOT_INTERRUPTIBLE", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_INTERRUPTED", "focus")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_SPELLCAST_FAILED", "focus")
