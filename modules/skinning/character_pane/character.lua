...
pcall(charCombatFrame.RegisterEvent, charCombatFrame, "PLAYER_REGEN_ENABLED")
...
pcall(eventFrame.RegisterEvent, eventFrame, "SOCKET_INFO_UPDATE")
pcall(eventFrame.RegisterEvent, eventFrame, "PLAYER_SPECIALIZATION_CHANGED")
pcall(eventFrame.RegisterUnitEvent, eventFrame, "UNIT_STATS", "player")
pcall(eventFrame.RegisterEvent, eventFrame, "PLAYER_ENTERING_WORLD")
pcall(eventFrame.RegisterEvent, eventFrame, "INSPECT_READY")
pcall(eventFrame.RegisterEvent, eventFrame, "PLAYER_AVG_ITEM_LEVEL_UPDATE")
...
pcall(eventFrame.RegisterEvent, eventFrame, "PVP_MATCH_ACTIVE")
