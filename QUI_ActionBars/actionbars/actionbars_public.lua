...
function ActionBarsOwned:Initialize()
    ...
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_PAGE_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_SLOT_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "GAME_PAD_ACTIVE_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_BONUS_ACTIONBAR")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_OVERRIDE_ACTIONBAR")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_POSSESS_BAR")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_SHAPESHIFT_FORM")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_SHAPESHIFT_FORMS")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_SHAPESHIFT_COOLDOWN")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_SHAPESHIFT_USABLE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_STEALTH")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_BINDINGS")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_REGEN_ENABLED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "CURSOR_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_ENTERING_WORLD")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_REGEN_DISABLED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_LEVEL_UP")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ZONE_CHANGED_NEW_AREA")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ZONE_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ZONE_CHANGED_INDOORS")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_DIFFICULTY_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_INSTANCE_INFO")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "CHALLENGE_MODE_START")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "CHALLENGE_MODE_COMPLETED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "CHALLENGE_MODE_RESET")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ENCOUNTER_START")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ENCOUNTER_END")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UNIT_ENTERED_VEHICLE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UNIT_EXITED_VEHICLE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_EXTRA_ACTIONBAR")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_UPDATE_COOLDOWN")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_UPDATE_COOLDOWN")
    pcall(ownedEventFrame.RegisterUnitEvent, ownedEventFrame, "UNIT_SPELLCAST_STOP", "player")
    pcall(ownedEventFrame.RegisterUnitEvent, ownedEventFrame, "UNIT_SPELLCAST_INTERRUPTED", "player")
    pcall(ownedEventFrame.RegisterUnitEvent, ownedEventFrame, "UNIT_SPELLCAST_EMPOWER_STOP", "player")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_UPDATE_USABLE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_UPDATE_STATE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_SHOWGRID")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "ACTIONBAR_HIDEGRID")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_UPDATE_CHARGES")
    pcall(ownedEventFrame.RegisterUnitEvent, ownedEventFrame, "UNIT_AURA", "player")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_UPDATE_ICON")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "MODIFIER_STATE_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_ENTER_COMBAT")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_LEAVE_COMBAT")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PET_BATTLE_OPENING_START")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PET_BATTLE_CLOSE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "LOSS_OF_CONTROL_ADDED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "LOSS_OF_CONTROL_UPDATE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_ACTIVATION_OVERLAY_GLOW_SHOW")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_ACTIVATION_OVERLAY_GLOW_HIDE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELLS_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_UPDATE_USABLE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "SPELL_FLYOUT_UPDATE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UPDATE_VEHICLE_ACTIONBAR")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UNIT_INVENTORY_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PLAYER_MOUNT_DISPLAY_CHANGED")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "START_AUTOREPEAT_SPELL")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "STOP_AUTOREPEAT_SPELL")
    if IS_MIDNIGHT then
        pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "LEARNED_SPELL_IN_SKILL_LINE")
    end
    ...
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PET_BAR_UPDATE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PET_BAR_UPDATE_COOLDOWN")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "PET_UI_UPDATE")
    pcall(ownedEventFrame.RegisterEvent, ownedEventFrame, "UNIT_PET")
